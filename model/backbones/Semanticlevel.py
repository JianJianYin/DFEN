...
class SemanticLevelContext(nn.Module):
    def __init__(self, feats_channels, transform_channels, concat_input, output_dim):
        ...
        if concat_input:
            self.bottleneck = nn.Sequential(
                nn.Conv2d(feats_channels * 2, output_dim, kernel_size=3, stride=1, padding=1, bias=False),
