...
parser.add_argument('--root_path', type=str,
                    default='/home/y212202015/KBS/TransISNet/ISIC2018', help='root dir for data')
parser.add_argument('--config_file', type=str,
                    default='swin_224_7_3level', help='config file name w/o suffix')
parser.add_argument('--dataset', type=str,
                    default='isic2018', help='Synapse/isic2017/isic2018')
parser.add_argument('--list_dir', type=str,
                    default='/home/JianjianYin/transdeeplab/lists/lists_Synapse', help='list dir')
parser.add_argument('--num_classes', type=int,
                    default=1, help='output channel of network')
parser.add_argument('--output_dir', type=str, default='/home/y212202015/KBS/TransISNet/isic2018', help='output dir')                   
...
parser.add_argument('--base_lr', type=float,  default=0.06,
                    help='segmentation network learning rate')  # uper: 0.05
...
if __name__ == "__main__":
    ...
    if dataset_name == "Synapse":
        model_config.DecoderConfig.num_classes = 9  # Syn
        args.root_path = "/home/JianjianYin/transISNet/data/Synapse/train_npz"
    elif dataset_name == "isic2017":
        model_config.DecoderConfig.num_classes = 1   #  Isic2017
        args.root_path = '/home/JianjianYin/transISNet/ISIC2017'
    elif dataset_name == "isic2018":
        model_config.DecoderConfig.num_classes = 1   #  Isic2017
        args.root_path = '/home/y212202015/KBS/TransISNet/ISIC2018'
    elif dataset_name == 'busi':
        model_config.DecoderConfig.num_classes = 1
    ...
    print("加载完毕")
    trainer = {'Synapse': trainer_synapse,'isic2017':trainer_ISIC,'isic2018':trainer_ISIC,'busi':trainer_busi,'mix':trainer_mix}
